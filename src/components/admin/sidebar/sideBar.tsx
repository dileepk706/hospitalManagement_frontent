...
import SideBarList from '../../doctor/sideBar/SideBarList';
import Nav from '../../doctor/nav/Nav';
import { Link } from 'react-router-dom';

type drawerProp={
    isAdmin?:boolean
}
const Drawer:React.FC<drawerProp> = ({isAdmin}) => {
  ...
  return (
    < >
      ...
      <Nav toggleDrawer={toggleDrawer} isAdmin={isAdmin} />
